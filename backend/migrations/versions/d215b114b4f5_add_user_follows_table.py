...
Revision ID: d215b114b4f5
Revises: 
Create Date: 2025-06-16 11:54:40.380755
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['followed_id'], ['users.id'], name=op.f('followers_ibfk_1')),
    sa.ForeignKeyConstraint(['follower_id'], ['users.id'], name=op.f('followers_ibfk_2')),
    sa.PrimaryKeyConstraint('follower_id', 'followed_id'),
    ...
    sa.Column('created_at', mysql.DATETIME(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['post_id'], ['posts.id'], name=op.f('post_tags_ibfk_1')),
    sa.ForeignKeyConstraint(['tag_id'], ['tags.id'], name=op.f('post_tags_ibfk_2')),
    ...
    sa.Column('tag_id', mysql.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('created_at', mysql.DATETIME(), nullable=True),
    sa.ForeignKeyConstraint(['tag_id'], ['tags.id'], name=op.f('user_tags_ibfk_1')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('user_tags_ibfk_2')),
